...
func TestSlugMakeLang(t *testing.T) {
	testCases := []struct {
		...
		{"cs", "ěščřžýáíéúůóňťĚŠČŘŽÝÁÍÉÚŮÓŇŤ", "escrzyaieuuontescrzyaieuuont", true, false},
		{"cs", "ěščřžýáíéúůóňťĚŠČŘŽÝÁÍÉÚŮÓŇŤ", "escrzyaieuuontESCRZYAIEUUONT", false, false},
		{"ces", "ěščřžýáíéúůóňťĚŠČŘŽÝÁÍÉÚŮÓŇŤ", "escrzyaieuuontescrzyaieuuont", true, false},
		{"ces", "ěščřžýáíéúůóňťĚŠČŘŽÝÁÍÉÚŮÓŇŤ", "escrzyaieuuontESCRZYAIEUUONT", false, false},
		{"de", "Wir mögen Bücher & Käse", "wir-moegen-buecher-und-kaese", true, false},
		{"de", "Wir mögen Bücher & Käse", "Wir-moegen-Buecher-und-Kaese", false, false},
		{"de", "Äpfel Über Österreich", "aepfel-ueber-oesterreich", true, false},
		{"de", "Äpfel Über Österreich", "Aepfel-Ueber-Oesterreich", false, false},
		{"en", "äÄäöÖöüÜü", "aaaooouuu", true, false},
		{"en", "äÄäöÖöüÜü", "aAaoOouUu", false, false},
		{"gr", "ϊχώΩϋ", "ixwwu", true, false},
		{"gr", "ϊχώΩϋ", "ixwwu", false, false},
		{"hu", "Árvíztűrő tükörfúrógép", "arvizturo-tukorfurogep", true, false},
		{"hu", "Árvíztűrő tükörfúrógép", "Arvizturo-tukorfurogep", false, false},
		{"hu", "SzÉlÜtÖtt ŰrÚjsÁgírÓnŐ", "SzElUtOtt-UrUjsAgirOnO", false, false},
		{"Ell", "ϊχώΩϋ", "ixwwu", true, false},
		{"Ell", "ϊχώΩϋ", "ixwwu", false, false},
		{"tr", "şüöğıçŞÜÖİĞÇ", "suogicsuoigc", true, false},
		{"tr", "şüöğıçŞÜÖİĞÇ", "suogicSUOIGC", false, false},
		{"kk", "әғһіңөқұүӘҒҺІҢӨҚҰҮ", "aghinoquuaghinoquu", true, false},
		{"kk", "әғһіңөқұүӘҒҺІҢӨҚҰҮ", "aghinoquuAGHINOQUU", false, false},
		// & fun.
		{"cs", "Toto & Tamto", "toto-a-tamto", true, false},
		{"cs", "Toto & Tamto", "Toto-a-Tamto", false, false},
		{"cs", "Toto @ Tamto", "toto-zavinac-tamto", true, false},
		{"cs", "Toto @ Tamto", "Toto-zavinac-Tamto", false, false},
		{"ces", "Toto & Tamto", "toto-a-tamto", true, false},
		{"ces", "Toto & Tamto", "Toto-a-Tamto", false, false},
		{"ces", "Toto @ Tamto", "toto-zavinac-tamto", true, false},
		{"ces", "Toto @ Tamto", "Toto-zavinac-Tamto", false, false},
		{"de", "This & that", "this-und-that", true, false},
		{"en", "This & that", "this-and-that", true, false},
		{"es", "This & that", "this-y-that", true, false},
		{"fi", "This & that", "this-ja-that", true, false},
		{"fr", "This & that", "this-et-that", true, false},
		{"fr", "This @ that", "this-arobase-that", true, false},
		{"gr", "This & that", "this-kai-that", true, false},
		{"id", "This & that", "this-dan-that", true, false},
		{"ell", "This & that", "this-kai-that", true, false},
		{"Ell", "This & that", "this-kai-that", true, false},
		{"kk", "This & that", "this-jane-that", true, false},
		{"kk", "This @ that", "this-that", true, false},
		{"nl", "This & that", "this-en-that", true, false},
		{"pl", "This & that", "this-i-that", true, false},
		{"pol", "This & that", "this-i-that", true, false},
		{"sv", "This & that", "this-och-that", true, false},
		{"sv", "This @ that", "this-snabel-a-that", true, false},
		{"swe", "This & that", "this-och-that", true, false},
		{"swe", "This @ that", "this-snabel-a-that", true, false},
		{"nb", "Ærlig, Østen, Åse", "aerlig-oesten-aase", true, false},
		{"nb", "This & that", "this-og-that", true, false},
		{"nb", "This @ that", "this-at-that", true, false},
		{"nn", "Ærlig, Østen, Åse", "aerlig-oesten-aase", true, false},
		{"nn", "This & that", "this-og-that", true, false},
		{"nn", "This @ that", "this-at-that", true, false},
		{"tr", "This & that", "this-ve-that", true, false},
		{"sl", "đanković & Kožušček", "dzankovic-in-kozuscek", true, false},
		{"sl", "ĐankoVIĆ & KOŽUŠČEK", "DZankoVIC-in-KOZUSCEK", false, false},
		{"test", "This & that", "this-and-that", true, false}, // unknown lang, fallback to "en"
		// Test defaultSub, when adding new lang copy/paste this line,
		// it contain special characters.
		{"cs", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"de", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"en", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"es", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"fi", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"gr", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"kk", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"nb", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"nn", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"nl", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"pl", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"sl", "1\"2'3’4-5–6—7―8", "1234-5-6-7-8", true, false},
		{"sv", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
		{"tr", "1\"2'3’4‒5–6—7―8", "1234-5-6-7-8", true, false},
	}

	for index, smlt := range testCases {
		Lowercase = smlt.lowercase
		Titlecase = smlt.titlecase
